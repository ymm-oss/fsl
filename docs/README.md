...
| [`DESIGN-changelog-fragments.md`](DESIGN-changelog-fragments.md) | Accepted #737 decision record: GO for `CHANGELOG.md` `[Unreleased]` fragments (C1), NO-GO for fragmenting the contract documents (C2), with the replay measurement, five fail-closed controls, migration sites, and rollback/reversal rule — implementation is a separate follow-up |
