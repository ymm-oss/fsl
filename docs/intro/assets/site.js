  ...
  const BACKBONE_STAGES = [
    ...
    },
    {
      ...
      en: {
        ...
        contract: "<code>implements Business from \"file\" { }</code> — a failed seam becomes the top-level <code>result</code> and exits 1; <code>implements.result</code> is <code>\"refines\"</code> only when the seam holds.",
      ...
      ja: {
        ...
        contract: "<code>implements Business from \"file\" { }</code> — seam が失敗すると top-level の <code>result</code> になり exit 1。<code>implements.result</code> が <code>\"refines\"</code> なのは seam が成立するときだけ。",
