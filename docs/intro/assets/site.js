  ...
  const BACKBONE_STAGES = [
    ...
    },
    {
      ...
      en: {
        ...
        contract: "<code>implements Business from \"file\" { }</code> — a failed seam becomes the top-level <code>result</code> and exits 1; <code>\"refines\"</code> is the only passing value.",
      ...
      ja: {
        ...
        contract: "<code>implements Business from \"file\" { }</code> — seam が失敗すると top-level の <code>result</code> になり exit 1。合格値は <code>\"refines\"</code> だけ。",
