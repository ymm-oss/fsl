...
GALLERY_CASES = [
    ...
    GalleryCase("valid/tiny_option_structural_equality.fsl", "verify --depth 1 --deadlock ignore", "verified"),
    ...
    GalleryCase("valid/small_forbidden_guarded_cancel.fsl", "verify --depth 6 --deadlock ignore", "verified"),
    ...
    GalleryCase("errors/forbidden_op_accepted.fsl", "check", "error", "forbidden"),
