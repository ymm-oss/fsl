...
const DECLARATION_KEYWORDS: &[DeclarationKeyword] = &[
    ...
    DeclarationKeyword { value: "spec", role: Some(SymbolRole::Namespace), context: Some(Context::Top) },
    DeclarationKeyword { value: "compose", role: Some(SymbolRole::Namespace), context: Some(Context::Top) },
    DeclarationKeyword { value: "requirements", role: Some(SymbolRole::Namespace), context: Some(Context::Top) },
    DeclarationKeyword { value: "business", role: Some(SymbolRole::Namespace), context: Some(Context::Top) },
    DeclarationKeyword { value: "governance", role: Some(SymbolRole::Namespace), context: Some(Context::Top) },
    DeclarationKeyword { value: "refinement", role: Some(SymbolRole::Namespace), context: Some(Context::Top) },
    DeclarationKeyword { value: "domain", role: Some(SymbolRole::Namespace), context: Some(Context::Top) },
    DeclarationKeyword { value: "dbsystem", role: Some(SymbolRole::Namespace), context: Some(Context::Top) },
    DeclarationKeyword { value: "ai_component", role: Some(SymbolRole::Namespace), context: Some(Context::Top) },
    DeclarationKeyword { value: "agent", role: Some(SymbolRole::Namespace), context: Some(Context::Top) },
    DeclarationKeyword { value: "causal", role: Some(SymbolRole::Namespace), context: Some(Context::Top) },
    // Type declarations.
    DeclarationKeyword { value: "type", role: Some(SymbolRole::Type), context: None },
    DeclarationKeyword { value: "number", role: Some(SymbolRole::Type), context: None },
    DeclarationKeyword { value: "entity", role: Some(SymbolRole::Type), context: None },
    DeclarationKeyword { value: "enum", role: Some(SymbolRole::Type), context: Some(Context::Enum) },
    DeclarationKeyword { value: "struct", role: Some(SymbolRole::Type), context: Some(Context::Struct) },
    DeclarationKeyword { value: "table", role: Some(SymbolRole::Type), context: Some(Context::Struct) },
    // Action declarations.
    DeclarationKeyword { value: "action", role: Some(SymbolRole::Function), context: Some(Context::Action) },
    DeclarationKeyword { value: "transition", role: Some(SymbolRole::Function), context: Some(Context::Action) },
    DeclarationKeyword { value: "tool", role: Some(SymbolRole::Function), context: Some(Context::Action) },
    DeclarationKeyword { value: "command", role: Some(SymbolRole::Function), context: Some(Context::Action) },
    DeclarationKeyword { value: "effect", role: Some(SymbolRole::Function), context: Some(Context::Action) },
    DeclarationKeyword { value: "migration", role: Some(SymbolRole::Function), context: Some(Context::Action) },
    DeclarationKeyword { value: "decide", role: Some(SymbolRole::Function), context: Some(Context::Action) },
    DeclarationKeyword { value: "evolve", role: Some(SymbolRole::Function), context: Some(Context::Action) },
    DeclarationKeyword { value: "def", role: Some(SymbolRole::Function), context: Some(Context::Action) },
    // Property declarations.
    DeclarationKeyword { value: "invariant", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "trans", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "reachable", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "until", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "unless", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "leadsTo", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "property", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "requirement", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "acceptance", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "forbidden", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "control", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "policy", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "goal", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "claim", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    DeclarationKeyword { value: "expectation", role: Some(SymbolRole::Property), context: Some(Context::Other) },
    // Variable declarations.
    DeclarationKeyword { value: "const", role: Some(SymbolRole::Variable), context: Some(Context::Other) },
    DeclarationKeyword { value: "actor", role: Some(SymbolRole::Variable), context: Some(Context::Other) },
    DeclarationKeyword { value: "process", role: Some(SymbolRole::Variable), context: Some(Context::Other) },
    DeclarationKeyword { value: "kpi", role: Some(SymbolRole::Variable), context: Some(Context::Other) },
    DeclarationKeyword { value: "authority", role: Some(SymbolRole::Variable), context: Some(Context::Other) },
    DeclarationKeyword { value: "aggregate", role: Some(SymbolRole::Variable), context: Some(Context::Other) },
    DeclarationKeyword { value: "projection", role: Some(SymbolRole::Variable), context: Some(Context::Other) },
    DeclarationKeyword { value: "environment", role: Some(SymbolRole::Variable), context: Some(Context::Other) },
    DeclarationKeyword { value: "artifact", role: Some(SymbolRole::Variable), context: Some(Context::Other) },
    DeclarationKeyword { value: "column", role: Some(SymbolRole::Variable), context: Some(Context::Other) },
    DeclarationKeyword { value: "variable", role: Some(SymbolRole::Variable), context: Some(Context::Other) },
    // Context-only declarations.
    DeclarationKeyword { value: "preservation", role: Some(SymbolRole::Namespace), context: Some(Context::Other) },
    DeclarationKeyword { value: "state", role: None, context: Some(Context::State) },
    DeclarationKeyword { value: "init", role: None, context: Some(Context::Other) },
    DeclarationKeyword { value: "verify", role: None, context: Some(Context::Other) },
];
