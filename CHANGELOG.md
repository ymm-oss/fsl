...
- The authoritative Rust workspace now has one evidence-backed component design
  ...
  triggers. Migration-era documentation now consistently treats Python as
  frozen compatibility evidence rather than the active product authority, and
  concrete/symbolic failure agreement now includes a corrupted-evidence
  negative control.
